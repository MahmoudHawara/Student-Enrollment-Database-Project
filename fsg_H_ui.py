...
################################################################################
## Form generated from reading UI file 'fsg_H.ui'
##
...
"border-style: outset")
        ...
        self.department = QFrame(self.mainPage)
        ...
        self.verticalLayout_2 = QVBoxLayout(self.department)
        self.verticalLayout_2.setSpacing(15)
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.frame = QFrame(self.department)
        ...
        self.label_2 = QLabel(self.department)
        ...
        self.verticalLayout_9.addWidget(self.department, 0, Qt.AlignHCenter)

        self.photo = QFrame(self.mainPage)
        self.photo.setObjectName(u"photo")
        self.photo.setMinimumSize(QSize(400, 400))
        self.photo.setMaximumSize(QSize(400, 400))
        ...
        self.label_4.setMinimumSize(QSize(400, 400))
        self.label_4.setMaximumSize(QSize(400, 400))
        self.label_4.setPixmap(QPixmap(u"Images/2.png"))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Computer and Commnuication", None))
        self.label_4.setText("")
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"6", None))
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Cousrses", None))
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"Enter", None))
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"115", None))
