...
class Ui_MainWindow(object):
        ...
        "}")
                ...
                # self.lineEdit.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
                self.lineEdit.setPlaceholderText("Search....")
                self.lineEdit.setObjectName("lineEdit")
                self.verticalLayout_3.addWidget(self.lineEdit, 0, QtCore.Qt.AlignVCenter)
